...
def generate_classification_map(dataset_name, model_path, data_path, results_dir):
    """
    Generate classification map for a specific dataset
    
    Args:
        dataset_name: Name of the dataset ('Houston2013' or 'Trento')
    ...
    if dataset_name.lower() == 'houston2013':
        ...
        colors = [
            ...
            [1.0, 0.0, 0.0],      # Red - Apples
            [0.0, 0.0, 1.0],      # Blue - Buildings  
            [0.5, 0.5, 0.5],      # Gray - Ground
            [0.0, 0.5, 0.0],      # Dark Green - Woods
            [0.0, 1.0, 0.0],      # Green - Vineyard
            [1.0, 1.0, 0.0]       # Yellow - Roads
        ]
    ...
    # Save MATLAB file
    mat_save_path = os.path.join(results_subdir, f'{dataset_name}_pred_all.mat')
    ...
    img_save_path = os.path.join(results_subdir, f'{dataset_name}_classmap.png')
...
if __name__ == '__main__':
    ...
    # Define dataset paths and model locations
    datasets = [
        {
            'name': 'Houston2013',
            'data_path': '/beluga/Hackathon15/dataset/Houston2013',
            'model_path': '/beluga/Hackathon15/trained_models/Houston2013/CALC_Houston2013.pkl'
        },
        {
            'name': 'Trento', 
            'data_path': '/beluga/Hackathon15/dataset/Trento',
            'model_path': '/beluga/Hackathon15/trained_models/Trento/CALC_Trento.pkl'
        }
    ]
    ...
    for dataset in datasets:
        if os.path.exists(dataset['model_path']):
            ...
            print("Please train the model first using train_saeid.py")